...
This module contains all of the entities states.
"""
...
from src.states.entities.entities_states.EDeadState import EDeadState

(EWalkState, EIdleState, EShootState, EDeadState)
